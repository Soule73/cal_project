...
<%@ taglib prefix="tgs" tagdir="/WEB-INF/tags/subscriptions" %>

<%@ page import="com.cal.Routes" %>
<!DOCTYPE html>
<html lang="fr">

<tg:head-style title="Liste des Abonnement"/>

<body
        x-data="{ page: 'listSubscriptions', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
        x-init="
          darkMode = JSON.parse(localStorage.getItem('darkMode'));
          selected = 'listSubscriptions';
    ...
    <div
        ...
        <main>
            <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                ...
                <!-- Breadcrumb Start -->
                <tg:breadcrumb name="Liste des Abonnements"/>
                <!-- Breadcrumb End -->
                    ...
                    <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                        <div class="flex flex-wrap justify-between items-center pb-2">
                            <div class="max-w-md">
                                <input
                                        ...
                                        x-model="searchQuery" @input.debounce.500="fetchSubscriptions"
                                        placeholder="Recherche..." type="search"
                                        title="Search within table">
                            </div>
                            <div></div>
                            <tgs:add-or-update-form />
                        </div>
                        <div class="max-w-full overflow-x-auto">
                            <table class="w-full table-auto">
                                ...
                                <tr class="bg-gray-2 text-left dark:bg-meta-4">
                                    <th
                                            class=" w-max px-4 py-4 font-medium text-black dark:text-white xl:pl-11">
                                        ID</th>
                                    <th
                                ...
                                <tbody>
                                <template x-for="subscription in subscriptions"
                                          :key="subscription.id">
                                    <tr>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                            <h5 class="font-medium text-black dark:text-white"
                                                x-text="subscription.id"></h5>
                                        </td>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white"
                                               x-text="subscription.name"></p>
                                        </td>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white"
                                               x-text="subscription.price"></p>
                                        </td>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white"
                                               x-text="subscription.description"></p>
                                        </td>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white"
                                               x-text="subscription.type"></p>
                                        </td>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white"
                                               x-text="subscription.status"></p>
                                        </td>
                                        <td
                                                class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                <button @click="editSubscription(subscription)"
                                                        class="hover:text-primary" title="Modifier">
                        ...
                        <div class=" my-2">
                            ...
                            <button @click="nextPage" :disabled="page >= totalPages"
                                    class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-md">Suivant</button>
                        </div>
                    </div>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('subscriptionDataTable', () => ({
            subscriptions: [],
            searchQuery: '',
            page: 1,
            pageSize: 10,
            ...
            get totalPages() {
                return Math.ceil(this.totalSubscriptions / this.pageSize);
            },
            ...
            editSubscription(subscription) {
                const data = {
                    ...
                    accessConditions: subscription.accessConditions,
                    type: subscription.type,
                    status: subscription.status
                };
                window.subscriptionForm(data);
            },
            ...
            deleteSubscription(subscription) {
                ...
                window.deleteSubscriptionForm(data);
            },
