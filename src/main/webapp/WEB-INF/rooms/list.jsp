    ...
    <%@ taglib prefix="tg" tagdir="/WEB-INF/tags" %>
        <%@ taglib prefix="tgr" tagdir="/WEB-INF/tags/rooms" %>
            ...
            <%@ page import="com.cal.Routes" %>
                ...
                <tg:head-style title="Liste des Salle" />
                        ...
                        document.addEventListener('alpine:init', () => {
                            Alpine.data('roomDataTable', () => ({
                                ...
                                fetchRooms() {
                                    ...
                                    const url = '${pageContext.request.contextPath}<%=Routes.ROOM_LIST%>';
                                    const data = {
                                        page: this.page,
                                ...
                                init() {
                                    this.fetchRooms();
                                    window.refreshRooms = this.fetchRooms.bind(this);
                                },
