...
<% User currentUser = (User) session.getAttribute("user");
    boolean
            isAdmin = currentUser.getRoles().stream().anyMatch(role ->
            role.getName().equals("ADMIN"));
%>

<% User apprenant = (User)
        request.getAttribute("apprenant"); %>
...
<body x-data="{ page: '<%= isAdmin ? "viewApprenant":"monProfil"%>', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false,
            'scrollTop': false }"
      x-init="
            darkMode =
        ...
        <main>
            <div
                ...
                <div
                    ...
                    <div
                            class="relative z-20 h-35 md:h-65">
                        <img src="${pageContext.request.contextPath}/src/images/cover/cover.svg"
                             alt="profile cover"
                             class="h-full w-full rounded-tl-sm rounded-tr-sm object-cover object-center"/>

                    </div>
                    <div
                            class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                        <div
                ...
                <div
                    ...
                    <div
                            class="max-w-full py-6 overflow-x-auto">
                        <table
                ...
                <!-- ====== Subscrition Start -->
                <div x-data="learnerSubscriptions"
                     x-cloak>
                    <div
                        ...
                        <div
                                class="max-w-full py-6 overflow-x-auto">
                            <template
                                    x-for="subscription in subscriptions"
                                    :key="subscription.id">
                                <div x-data="{ accordionOpen: false }"
                                    ...
                                    <button
                                        ...
                                        <h4 class="text-left text-title-xsm font-medium text-black dark:text-white"
                                            x-text="subscription.name">
                                        </h4>
                                        <div @click="unSubcr(subscription)"
                                             class=" text-red-600">
                                            Désabonner
                                        </div>
                                    </button>
                                    <div x-show="accordionOpen"
                                        ...
                                        <p class="ml-16.5 py-4 font-medium"
                                           x-text="subscription.description">
                                        </p>
                                        <div
                                            ...
                                            <h4
                                                    class="mb-1 text-xl font-bold text-black dark:text-white">
                                                Cours
                                            </h4>
                                            <div
                                                    class="max-w-full pb-6 overflow-x-auto">
                                                <table
                                                        class="w-full table-auto">
                                                    <thead>
                                                    <tr
                                                    ...
                                                    <tbody>
                                                    <template
                                                            x-for="course in subscription.courses"
                                                            :key="course.id">
                                                        <tr>
                                                            <td
                                                                    class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                                <p class="text-black dark:text-white"
                                                                   x-text="course.identifier">
                                                                </p>
                                                            </td>
                                                            <td
                                                                    class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('learnerSubscriptions', () => ({
            ...
            fetchSubscriptions() {
                const url = `${pageContext.request.contextPath}<%=Routes.LEARN_SUBCRIPTIONS%>?learnerId=${apprenant.id}`;
