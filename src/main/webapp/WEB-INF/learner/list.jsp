                    ...
                    <div
                        ...
                        <div class="max-w-full overflow-x-auto">
                            <table class="w-full table-auto">
                                ...
                                <tbody>
                                <%
                                    List<Learner> apprenants = (List<Learner>) request.getAttribute("apprenants");
                                    if (apprenants != null) {
                                        for (Learner apprenant : apprenants) {
                                %>
                                <tr>
                                    <td
                                    ...
                                    <td
                                        ...
                                        <p class="text-black dark:text-white"><%= apprenant.getLastname() %>
                                        </p>
                                    </td>
                                    <td
                                            class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                        <p class="text-black dark:text-white"><%= apprenant.getFirstname() %>
                                        </p>
                                    </td>
                                    <td
                                            class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    ...
                                    <td
                                        ...
                                        <div class="flex items-center space-x-3.5">
                                            <a title="voir" href="${pageContext.request.contextPath}<%= Routes.LEARNER_SHOW %>?id=<%= apprenant.getId() %>"
                                            ...
                                            <a title="supprimer" href="${pageContext.request.contextPath}<%= Routes.LEARNER_UPDATE %>?id=<%= apprenant.getId() %>"
                                               class="hover:text-primary">
                                            ...
                                            <form action="${pageContext.request.contextPath}<%= Routes.LEARNER_DELETE %>"
