...
<tg:head-style title="Liste des Apprenants"/>
    ...
    <div
        ...
        <main>
            <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                ...
                <!-- Breadcrumb Start -->
                <tg:breadcrumb name="Liste des Apprenants"/>
                <!-- Breadcrumb End -->
                <%--                alert msg--%>
                <tg:alerts/>
                            ...
                            <table class="w-full table-auto">
                                <thead>
                                    <tr class="bg-gray-2 text-left dark:bg-meta-4">
                                        <th class=" w-max px-4 py-4 font-medium text-black dark:text-white xl:pl-11">
                                            ID
                                        </th>
                                ...
                                <template x-for="learner in learners" :key="learner.id">
                                    <tr>
                                        <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                            <h5 class="font-medium text-black dark:text-white" x-text="learner.id"></h5>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white" x-text="learner.lastname"></p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white" x-text="learner.firstname"></p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="inline-flex px-3 py-1 text-sm font-medium text-success" x-text="learner.email"></p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                <a title="Voir" :href="'${pageContext.request.contextPath}${Routes.LEARNER_SHOW}?id=' + learner.id" class="hover:text-primary">
                                                ...
                                                <button title="Modifier" @click="editLearner(learner)" class="hover:text-primary">
                                                ...
                                                <button @click="deleteLearner(learner)" class="text-red-400 hover:text-red-600" title="Supprimer">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('dataTable', () => ({
            ...
            get totalPages() {
                return Math.ceil(this.totalLearners / this.pageSize);
            },
            ...
            init() {
                this.isFetching = false;
                this.fetchData();
                window.refreshLearners = this.fetchData.bind(this);
            },
