                    ...
                    <div
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div
                                                ...
                                                <a title="Voir"
                                                   :href="'${pageContext.request.contextPath}${Routes.LANG_SHOW}?id=' + language.id"
                        ...
                        <div class=" my-2">
                            <button @click="prevPage"
                                    :disabled="page === 1"
                                    class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-md">Précédent
                            </button>
                            <span x-text="page"
                                  class="px-4 py-2"></span>
                            <button @click="nextPage"
                                    :disabled="page >= totalPages"
                                    class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-md">Suivant
                            </button>
                        </div>
                    </div>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('dataTable', () => ({
            ...
            fetchData() {
                ...
                const url = '${pageContext.request.contextPath}${Routes.LANG_LIST}';
                const data = {
                    page: this.page,
