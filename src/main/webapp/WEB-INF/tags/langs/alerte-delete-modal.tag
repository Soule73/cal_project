...
<div x-data="deleteLanguageForm()" x-init="init()" x-cloak>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('deleteLanguageForm', () => ({
            ...
            setDeleteForm(language) {
                console.log("language : " + language);
                this.deleteForm = { ...language };

                this.modalDesc = "La langue : " + this.deleteForm.name;
                this.modalOpen = true;
            },
            ...
            init() {
                window.deleteLanguageForm = this.setDeleteForm.bind(this);
            },
                ...
                fetch('<%=Routes.LANG_FORM %>', {
                    ...
                    .then(data => {
                        if (data.errors) {
                            ...
                            this.resetDeleteForm();
                            this.successMessage = "La langue a été supprimée avec succès!";
