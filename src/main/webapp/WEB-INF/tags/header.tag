...
<header
    ...
    <div
        ...
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <!-- Hamburger Toggle BTN -->
            <a class="block flex-shrink-0 lg:hidden text-white text-2xl font-bold" href="${pageContext.request.contextPath}/">
               CAL Center
            </a>
        </div>
        <div></div>
        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            ...
            <div class="relative" x-data="{ dropdownOpen: false }"
                ...
                <span class="hidden text-right lg:block">
                  ...
                  <img src="${pageContext.request.contextPath}/src/images/user/profile.svg" alt="User" />
                </span>

                    <svg :class="dropdownOpen && 'rotate-180'"
                         class="hidden fill-current sm:block" width="12" height="8"
                ...
                <div x-show="dropdownOpen"
                    ...
                    <form action="${pageContext.request.contextPath}<%=Routes.LOGOUT%>" method="post">
