...
<div x-data="deleteRoomForm()" x-init="init()" x-cloak>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('deleteRoomForm', () => ({
            modalTitle: "Êtes-vous sûr de vouloir supprimer cette salle ?",
            ...
            setDeleteForm(room) {
                this.deleteForm = { ...room };
                this.modalDesc = "La salle : "+this.deleteForm.name;
                this.modalOpen = true;
            },

            resetDeleteForm() {
                this.modalTitle = "Êtes-vous sûr de vouloir supprimer cette salle ?";
            ...
            init() {
                window.deleteRoomForm = this.setDeleteForm.bind(this);
            },
                ...
                fetch('<%=Routes.ROOM_FORM%>', {
                    ...
                    .then(data => {
                        if (data.errors) {
                            ...
                            this.resetDeleteForm();
                            this.successMessage = "La salle a été supprimée avec succès!";
