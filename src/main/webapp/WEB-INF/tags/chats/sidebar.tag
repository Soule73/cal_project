...
<%--            <input type="text"  class="w-full rounded border border-stroke bg-gray-2 py-2.5 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark-2" placeholder="Search..." spellcheck="false" data-ms-editor="true">--%>
...
<%--        </form>--%>
        <div class="no-scrollbar max-h-full space-y-2.5 overflow-auto">
            <div class="w-full px-4 h-full flex items-center  py-2">
                <p class="text-lg font-medium ">
                    Vous pouvez poster des messages pour trouver des partenaires de conversation, organiser
                    des groupes d'étude, ou échanger des conseils pour progresser dans l’apprentissage
                    d’une langue ensemble.
                </p>
            </div>
...
<%--                    <img src="${pageContext.request.contextPath}/src/images/user/profile.svg" alt="profile" class="h-full w-full object-cover object-center">--%>
