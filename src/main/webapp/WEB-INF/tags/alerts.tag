...
<%
    ...
    String flashMessage = (String) sessionMsg.getAttribute("flashMessage");
    String flashType = (String) sessionMsg.getAttribute("flashType");
    if (flashMessage != null && flashType != null) {
        sessionMsg.removeAttribute("flashMessage");
        sessionMsg.removeAttribute("flashType");
%>
...
<script> hideMessage('successMessage'); </script>
...
<script> hideMessage('errorMessage'); </script>
<% } %>
<% } %>