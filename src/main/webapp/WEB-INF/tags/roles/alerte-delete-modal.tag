...
<div x-data="deleteRoleForm()" x-init="init()" x-cloak>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('deleteRoleForm', () => ({
            modalTitle: "Êtes-vous sûr de vouloir supprimer cette role ?",
            ...
            setDeleteForm(role) {
                this.deleteForm = { ...role };
                this.modalDesc = "Le role : "+this.deleteForm.name;
                this.modalOpen = true;
            },

            resetDeleteForm() {
                this.modalTitle = "Êtes-vous sûr de vouloir supprimer cette role ?";
            ...
            init() {
                window.deleteRoleForm = this.setDeleteForm.bind(this);
            },
                ...
                fetch('<%=Routes.ROLE_FORM%>', {
                    ...
                    .then(data => {
                        if (data.errors) {
                            ...
                            this.resetDeleteForm();
                            this.successMessage = "Le role a été supprimée avec succès!";
