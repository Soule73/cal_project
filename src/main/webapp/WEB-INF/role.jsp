...
<tg:head-style title="Gestion des rôles" />
    ...
    <div
        ...
        <main>
            <div
                ...
                <!-- Breadcrumb Start -->
                <tg:breadcrumb name="Gestion des rôless" />
                <!-- Breadcrumb End -->
                <tgr:alerte-delete-modal />

                <!-- ====== Table Section Start -->
                <div class="flex flex-col gap-10"
                     x-data="roleDataTable">
                    <div
                            class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                        <div
                                class="flex flex-wrap justify-between items-center pb-2">
                            <div class="max-w-md">
                                <input
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                        x-model="searchQuery"
                                        @input.debounce.500="fetchRoles"
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('roleDataTable', () => ({
            ...
            fetchRoles() {
                ...
                const url = '${pageContext.request.contextPath}<%=Routes.ROLE_LIST%>';
                const data = {
                    page: this.page,
            ...
            init() {
                this.fetchRoles();
                window.refreshRoles = this.fetchRoles.bind(this);
            },
